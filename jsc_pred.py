...
Original file is located at
    https://colab.research.google.com/drive/1QlTCpCFZDUv3wJrIHOWyiQWhVZAwjE6T
...
plt.scatter(y_train1, y_train_pred1, color='royalblue', label='Train set: 0.543 RMSE')
plt.scatter(y_test1, y_pred1, color='deeppink', label='Test set: 1.013 RMSE')

plt.xlabel('Actual Jsc (mA/cm2)')
plt.ylabel('Predicted Jsc (mA/cm2)')
plt.legend()
#plt.grid(True)
plt.title('RF Model: Actual vs Predicted Jsc (mA/cm2)')
plt.savefig('RF_Jsc.png', dpi=300, bbox_inches='tight')
...
plt.scatter(y_train2, y_train_pred2, edgecolors='royalblue',
                linewidth=1.2,color='royalblue', label='Train set: 0.744 RMSE')
plt.scatter(y_test2, y_pred2, edgecolors='deeppink',
                linewidth=1.2,color='deeppink', label='Test set: 1.171 RMSE')
plt.xlabel('Actual Jsc (mA/cm2)')
plt.ylabel('Predicted Jsc (mA/cm2)')
plt.legend()
#plt.grid(True)
plt.title('GBR Model: Actual vs Predicted Jsc (mA/cm2)')
plt.savefig('GBR_Jsc.png', dpi=300, bbox_inches='tight')
...
plt.scatter(y_train3, y_train_pred3, color='royalblue', label='Train set: 0.236 RMSE')
plt.scatter(y_test3, y_pred3, color='deeppink', label='Test set: 1.21 RMSE')

plt.xlabel('Actual Jsc (mA/cm2)')
plt.ylabel('Predicted Jsc (mA/cm2)')
plt.legend()
#plt.grid(True)
plt.title('XGB Model: Actual vs Predicted Jsc (mA/cm2)')
plt.savefig('XGB_Jsc.png', dpi=300, bbox_inches='tight')
...
plt.scatter(y_train4, y_train_pred4, color='royalblue', label='Train Set: 0.419 RMSE')
plt.scatter(y_test4, y_pred4, color='deeppink', label='Test set: 1.126 RMSE')

plt.xlabel('Actual Jsc (mA/cm2)')
plt.ylabel('Predicted Jsc (mA/cm2)')
plt.legend()
#plt.grid(True)
plt.title('CB Model: Actual vs Predicted Jsc (mA/cm2)')
plt.savefig('CB_Jsc.png', dpi=300, bbox_inches='tight')
...
shap.plots.scatter(shap_values[:,'FA'],color=shap_values[:,'BG'])
...
shap.plots.scatter(shap_values[:,'Br'],color=shap_values[:,'BG'])
...
shap.plots.scatter(shap_values[:,'Sn'])

shap.plots.scatter(shap_values[:,'h_mobility'])

# your scatter plot
shap.plots.scatter(shap_values[:, 'e_mobility'], show=False)
...
shap.initjs()
shap.plots.force(shap_values[892])